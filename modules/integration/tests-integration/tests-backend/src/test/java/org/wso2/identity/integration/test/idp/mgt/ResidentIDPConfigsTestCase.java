...
public class ResidentIDPConfigsTestCase extends ISIntegrationTest {
    ...
    public static Object[][] federatedAuthConfigURLProvider() {
        ...
        return new Object[][]{
                ...
                {"carbon.super", "OAuth1AuthorizeUrl", "https://localhost:9853/t/carbon.super/oauth/authorize-url",
                        "Expected OAuth10a Authorize URL is not found"},
                {"carbon.super", "OAuth1RequestTokenUrl", "https://localhost:9853/t/carbon.super/oauth/request-token",
                        "Expected OAuth10a Request Token URL is not found"},
                {"carbon.super", "IdentityProviderUrl", "https://localhost:9853/t/carbon.super/passivests",
                        "Expected Passive STS URL is not found"},
                {"carbon.super", "OpenIdUrl", "https://localhost:9853/t/carbon.super/openidserver",
                        "Expected OpenID Server URL is not found"},
                {"carbon.super", "ECPUrl", "https://localhost:9853/t/carbon.super/samlecp",
                        "Expected ECP URL is not found"},
                {"carbon.super", "LogoutReqUrl", "https://localhost:9853/t/carbon.super/samlsso",
                        "Expected Logout URL is not found"},
                {"carbon.super", "ArtifactResolveUrl", "https://localhost:9853/t/carbon.super/samlartresolve",
                        "Expected Artifact Resolution URL is not found"},
                {"carbon.super", "SSOUrl", "https://localhost:9853/t/carbon.super/samlsso",
                        "Expected SSO URL is not found"},
                {"carbon.super", "IDENTITY_PROVIDER_URL", "https://localhost:9853/t/carbon.super/services/wso2carbon-sts",
                        "Expected Security Token Service URL is not found"},
                {"carbon.super", "OIDCWebFingerEPUrl", "https://localhost:9853/t/carbon.super/.well-known/webfinger",
                        "Expected Web finger Endpoint URL is not found"},
                {"carbon.super", "IdPEntityId", "https://localhost:9853/t/carbon.super/oauth2/token",
                        "Expected Token Endpoint URL is not found"},
                {"carbon.super", "OIDCCheckSessionEPUrl", "https://localhost:9853/t/carbon.super/oidc/checksession",
                        "Expected Session IFrame Endpoint URL is not found"},
                {"carbon.super", "OAuth2IntrospectEPUrl", "https://localhost:9853/t/carbon.super/oauth2/introspect",
                        "Expected Token Introspection Endpoint URL is not found"},
                {"carbon.super", "OAuth2RevokeEPUrl", "https://localhost:9853/t/carbon.super/oauth2/revoke",
                        "Expected Token Revocation Endpoint URL is not found"},
                {"carbon.super", "OIDCLogoutEPUrl", "https://localhost:9853/t/carbon.super/oidc/logout",
                        "Expected Logout Endpoint URL not found"},
                {"carbon.super", "OAuth2AuthzEPUrl", "https://localhost:9853/t/carbon.super/oauth2/authorize",
                        "Expected Authorization Endpoint URL is not found"},
                {"carbon.super", "OAuth2DCREPUrl", "https://localhost:9853/t/carbon.super/api/identity/oauth2/dcr/v1.1/register",
                        "Expected Dynamic Client Registration Endpoint URL is not found"},
                {"carbon.super", "OIDCDiscoveryEPUrl", "https://localhost:9853/t/carbon.super/oauth2/oidcdiscovery",
                        "Expected Dynamic Client Registration Endpoint URL is not found"},
                {"carbon.super", "OAuth2JWKSPage", "https://localhost:9853/t/carbon.super/oauth2/jwks",
                        "Expected OAuth2 JWKS Page is not found"},
                {"carbon.super", "OAuth2TokenEPUrl", "https://localhost:9853/t/carbon.super/oauth2/token",
                        "Expected Token Endpoint URL is not found"},
                {"carbon.super", "OAuth2UserInfoEPUrl", "https://localhost:9853/t/carbon.super/oauth2/userinfo",
    ...
    public static Object[][] provisioningConfigURLProvider() {
        ...
        return new Object[][]{
                {"carbon.super", "scimGroupEndpoint", "https://localhost:9853/t/carbon.super/wso2/scim/Groups",
                        "Expected SCIM Group Endpoint is not found"},
                {"carbon.super", "scimUserEndpoint", "https://localhost:9853/t/carbon.super/wso2/scim/Users",
                        "Expected SCIM User Endpoint is not found"},
                {"carbon.super", "scim2UserEndpoint", "https://localhost:9853/t/carbon.super/scim2/Users",
                        "Expected SCIM 2.0 User Endpoint is not found"},
                {"carbon.super", "scim2GroupEndpoint", "https://localhost:9853/t/carbon.super/scim2/Groups",
