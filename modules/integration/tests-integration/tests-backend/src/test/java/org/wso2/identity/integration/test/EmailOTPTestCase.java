...
public class EmailOTPTestCase extends ISIntegrationTest {
    ...
    private static String SAML_SSO_URL = "https://localhost:9853/samlsso";
    private static String COMMON_AUTH_URL = "https://localhost:9853/commonauth";
    private static String EMAIL_OTP_AUTHENTICATION_ENDPOINT_URL = "https://localhost:" +
    ...
    public void testInit() throws Exception {
        ...
        super.init(config.userMode);
        SAML_SSO_URL = getTenantQualifiedURL(SAML_SSO_URL, tenantInfo.getDomain());
        COMMON_AUTH_URL = getTenantQualifiedURL(COMMON_AUTH_URL, tenantInfo.getDomain());
        EMAIL_OTP_AUTHENTICATION_ENDPOINT_URL = getTenantQualifiedURL(
                EMAIL_OTP_AUTHENTICATION_ENDPOINT_URL, tenantInfo.getDomain());
